...
steps: PropTypes.arrayOf(PropTypes.shape({
  ...
  'highlightedSelectors': PropTypes.string,
  'mutationObservables': PropTypes.string,
  'resizeObservables': PropTypes.string,
})),
```
...
const steps = [
  {
    ...
    // If a child is removed: the highlight region is redrawn focused on the step selector node
